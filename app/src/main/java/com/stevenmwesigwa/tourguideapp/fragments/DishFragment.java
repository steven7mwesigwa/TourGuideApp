...
public class DishFragment extends Fragment {
    ...
    public DishFragment(Context context, ArrayList<TouristAttraction> dishArrayList) {
...
// Initialize Recycler View
         ...
         * */
        mAdapter = new TouristAttractionListAdapter(dishArrayList, context, "DishFragment");
